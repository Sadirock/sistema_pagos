            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget p-lg">
                        ...
                        <table
                            class="table table-striped table-bordered dt-responsive nowrap table supervisor-creditos-table">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget p-lg">
                        ...
                        <table
                            class="table table-striped table-bordered dt-responsive nowrap supervisor-payments-table">
                            <thead>
                                <tr class="visible-lg">
                                    <th>Nombres</th>
                                    <th>Fecha</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span
                                            class="value">{{(($sum->amount_neto)+($sum->amount_neto*$sum->utility))-($sum->total_summary)}}</span>
                                    </td>
                                </tr>
                                @endforeach
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget p-lg">
                        ...
                        <table class="table table-striped table-bordered dt-responsive nowrap supervisor-gas-table">
                            <thead>
                                <tr class="visible-lg">
                                    <th>Gasto</th>
                                    <th>Detalle</th>
